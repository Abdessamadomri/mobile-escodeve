...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: colors.warning, fontWeight: '600' },
  form: { gap: 18 },
  field: { gap: 6 },
  ...
  eyeText: { fontSize: 16 },
  btn: { backgroundColor: colors.primaryDark, borderRadius: 16, padding: 18, alignItems: 'center', marginTop: 8, shadowColor: colors.primaryDark, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 6 },
